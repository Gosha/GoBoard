...
internal sealed class GrabPose(Matrix4x4 panel, Matrix4x4 controller)
{
    ...
    public static void Verify()
    {
        ...
        Require(RelativePose.Near(GrabHandle.PanelOffset * grab.ControllerOffset * (hand * delta), GrabHandle.PanelOffset * dragged), "Handle/controller attachment diverged from the panel.");
